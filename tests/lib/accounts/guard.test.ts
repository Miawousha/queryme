...
const user = { id: "u1", username: "u", githubId: null, role: "user", createdAt: new Date() } as const;
const other = { id: "u2", username: "o", githubId: null, role: "user", createdAt: new Date() } as const;
const admin = { id: "a1", username: "a", githubId: null, role: "admin", createdAt: new Date() } as const;
const root = { id: "r1", username: "root", githubId: null, role: "user", createdAt: new Date() } as const;
