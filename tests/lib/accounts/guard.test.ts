...
const user = { id: "u1", username: "u", githubId: null, role: "user", status: "active", plan: "free", createdAt: new Date(), tosAcceptedAt: null } as const;
const other = { id: "u2", username: "o", githubId: null, role: "user", status: "active", plan: "free", createdAt: new Date(), tosAcceptedAt: null } as const;
const admin = { id: "a1", username: "a", githubId: null, role: "admin", status: "active", plan: "free", createdAt: new Date(), tosAcceptedAt: null } as const;
const root = { id: "r1", username: "root", githubId: null, role: "user", status: "active", plan: "free", createdAt: new Date(), tosAcceptedAt: null } as const;
